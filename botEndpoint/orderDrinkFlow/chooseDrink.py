...
async def chooseDrink(interaction: discord.Interaction, name, End_hour, End_min):
    ...
    c = view.answer3
    print(results)
    await interaction.followup.send(" ".join(results.get("Name")+results.get("a1")+results.get("a2")+results.get("a3")))
